...
def pal():
        print("*****/ Physical Activity Level (PAL) \\*****")
...
def macro():
        ...
        print("    (2) Maintenance")
        print("    (3) Fat Loss")
        goal = int(input("Enter your Goal number: "))
        ...
        if gender=="m" or gender=="M":
                ...
                print("Fat     :", str(int(fat_cal))+"cal", "|", str(int(fat_gm))+"gm", "|", str(int(fat_per))+"%")
                protein_per = (protein_cal * 100) / calories
                print("Proteins:", str(int(protein_cal))+"cal", "|", str(int(protein_gm))+"gm", "|", str(int(protein_per))+"%")
                carb_cal = calories - (fat_cal+protein_cal)
                carb_gm = calories/4
                carb_per = (carb_cal * 100) / calories
                print("Carbs   :", str(int(carb_cal))+"cal", "|", str(int(carb_gm))+"gm", "|", str(int(carb_per))+"%")
        elif gender=="f" or gender=="F":
...
while True:
        ...
        if a==1:
                ...
                print("\nMaintenance Calories:", maintenance_calories(), "calories")
                input("\nPress Enter to escape... ")
        elif a==7:
                print("\n*****/ Macro \\*****")
                macro()
